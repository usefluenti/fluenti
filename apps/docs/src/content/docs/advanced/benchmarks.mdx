...
description: Fluenti performance benchmarks — parser throughput, compilation speed, runtime interpolation, and framework-specific lookup times. Verified on CI.
sidebar:
  order: 2
---

...
If the branded type is too strict for your codebase, you can disable it via module augmentation (see [TypeScript Integration](/essentials/configuration/#typescript-integration) for full details):

---
title: Nuxt Routing
description: Locale-prefixed routes, NuxtLinkLocale, switchLocalePath, and routing strategies
---
...
Use `setLocale()` from `useI18n()` for programmatic switching (e.g., from a dropdown):

...
Fluenti works with React Router v7 as a client-side SPA with full Vite plugin support. See [Quick Start (React Router)](/getting-started/quick-start-react-router/) for initial setup.

...
TanStack Start is a full-stack React framework with file-based routing and SSR support. See the [Quick Start](/start/quick-start/) for initial setup.
...
Create page routes using `createFileRoute()`. Use direct-import `t` for compile-time translations:

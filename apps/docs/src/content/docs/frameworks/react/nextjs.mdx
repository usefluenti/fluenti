---
title: Next.js
description: "Fluenti for Next.js — App Router, React Server Components, Turbopack, and streaming SSR. Zero runtime parsing, ~3 KB bundle, 5-10x faster than next-intl."
---

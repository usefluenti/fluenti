...
SolidStart is a full-stack SolidJS framework with SSR and file-based routing. See [Quick Start (SolidStart)](/getting-started/quick-start-solidstart/) for initial setup.

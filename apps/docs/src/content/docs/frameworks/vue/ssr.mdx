...
For general SSR concepts and utilities, see the [SSR & Hydration guide](/advanced/ssr-hydration/).
...
1. **No shared global state** — Create a new `createFluentiVue()` instance per request on the server

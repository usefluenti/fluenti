...
1. **Install packages**
   ...
   pnpm add -D @fluenti/cli @fluenti/vite-plugin @vitejs/plugin-react vite-tsconfig-paths
   ```
...
- [TanStack Start guide](/frameworks/react/tanstack-start/) — full integration reference

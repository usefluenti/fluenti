...
import type { CompileTimeT, FluentInstanceExtended as FluentiInstanceExtended } from '@fluenti/core'

export declare function setLocale(locale: string): void
export declare function getI18n(): Promise<FluentiInstanceExtended & { locale: string }>

...
| [`@fluenti/solid`](https://www.npmjs.com/package/@fluenti/solid) | SolidJS -- `<Trans>`, `<Plural>`, `<Select>`, `<DateTime>`, `<NumberFormat>`, `useI18n()` |
| [`@fluenti/react`](https://www.npmjs.com/package/@fluenti/react) | React 19 -- `<Trans>`, `<Plural>`, `<Select>`, `<DateTime>`, `<NumberFormat>`, `useI18n()` |

...
import type { AllMessages, Locale, LocalizedString, Messages, CompiledMessage, MessageDescriptor, ChunkLoader, SplitRuntimeModule, DiagnosticsConfig } from '@fluenti/core'

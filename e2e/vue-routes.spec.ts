...
test.describe('Vue Routes — Default Locale (no prefix)', () => {
...
test.describe('Vue Routes — Locale Prefix Navigation', () => {
...
test.describe('Vue Routes — Switch Locale Paths', () => {
...
test.describe('Vue Routes — SEO Head Data', () => {
...
test.describe('Vue Routes — Round-trip Locale Switching', () => {
...
test.describe('Vue Routes — Hydration Integrity', () => {
  test('default locale page renders without fluenti errors', async ({ page }) => {
